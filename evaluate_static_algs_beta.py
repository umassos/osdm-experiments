...
def main():
    ...
    for month in range(1, max_month + 1):
        ...
        if args.analytical:
            ...
            try:
                ...
                candidate = f"best_thresholds_rhofactor_{args.rho_factor}_{args.trace}_{month}_{args.num_instances}"
    ...
    output_file = f'eval_beta_results/{args.trace}_rho{args.rho_factor}_gamma{args.gamma}_delta{args.delta}_c{args.c_delivery}_eps{args.eps_delivery}_prop{proportion_base}_scale{scale_factor}.pkl'
    os.makedirs('eval_beta_results', exist_ok=True)
