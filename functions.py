...
def load_scenarios_with_flexible(num_scenarios, T, trace_name, proportion_base=0.5, month=1, saved=True):
    """
...
def load_simple_scenarios_with_flexible_context(num_scenarios, trace_name, proportion_base=0.5, month=1, scale_divisor=40, saved=True):
    """
    Load scenarios with base and flexible demand plus deadlines.
