# cat /Users/adam/miniconda3/envs/pald/lib/python3.10/site-packages/ecos/ecos.py
import _ecos
...
def solve(c,G,h,dims,A=None,b=None, **kwargs):
    ...
    m,n1 = (0,len(c)) if G is None else map(int, G._shape) # this is the line we have to change to work gracefully with pytorch
